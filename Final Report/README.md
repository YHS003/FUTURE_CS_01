...
\*\*Project:\*\* FUTURE\_CS\_01 — Web Application Vulnerability Assessment
...
\* \*\*Evidence (PoCs):\*\* `SQLi Login Page/PoCs/Request.txt`, `SQLi Login Page/PoCs/Response.txt`, `SQLi Login Page/PoCs/Screenshot\_Browser\_Admin.png`, `SQLi Login Page/PoCs/Screenshot\_BurpSuite.png`, `SQLi Login Page/PoCs/Authentication\_bypass` (Burp saved item).
...
\* \*\*Evidence (PoCs):\*\* `DOM XSS Search/PoCs/DOM\_XSS\_Payload\_Screenshot.png`, `DOM XSS Search/PoCs/Result\_of\_Payload\_Screenshot.png`.
...
\* \*\*Evidence (PoCs):\*\* `Broken Access Control/PoCs/Intruder\_Grep-Match.png`, `Broken Access Control/PoCs/Intruder\_Password\_BruteForce.png`, `Broken Access Control/PoCs/Intruder\_Sucess\_Request.png`, `Broken Access Control/PoCs/Intruder\_Sucess\_Response.png`. Passwordlist stored in `Broken Access Control/Passwordlist/`.
...
\* \*\*Evidence (PoCs):\*\* `Security Misconfiguration/PoCs/robots\_file\_screenshot.png`, `Security Misconfiguration/PoCs/access\_to\_forbidden\_folder.png`, `Security Misconfiguration/PoCs/access\_to\_forbidden\_files.png`, `Security Misconfiguration/PoCs/acess\_confidential\_data.png`.
...
\*\*Suggested filename:\*\* `Final\_Report\_FUTURE\_CS\_01.md`
